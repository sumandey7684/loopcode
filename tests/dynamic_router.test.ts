...
import { closeSqliteHandle, removeSqliteDb, tempSqlitePath } from './helpers/sqlite-cleanup.js';

process.env.VITEST = '1';

describe('DynamicRouter', () => {
  const dbPath = tempSqlitePath('test-performance');

  beforeAll(() => {
    removeSqliteDb(dbPath);
